...
export const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className={`${styles.container} animate-fade-in-up delay-300`}
    >
      <h2 className={homeStyles.sectionTitle}>
        <span className="text-primary font-mono text-lg">03.</span> Featured
        Projects
      </h2>
      ...
      <div className={styles.grid}>
        {projects.map((project) => (
          <div
            key={project.id}
            onClick={() =>
              handleProjectClick(project.internalRoute, project.comingSoon)
            }
            role="button"
          ...
          >
            <Card className={`${styles.projectCard} ${project.comingSoon ? styles.disabledCard : ''}`}>
