    ...
    <section id="about" className={`${styles.container} animate-fade-in-up`}>
      ...
      <div className={styles.contentLeft}>
        ...
        <p className={styles.description}>
          I'm a full-stack developer taking lessons learned from debugging distributed systems 
          to build resilient applications. I enjoy writing code to solve real problems from 
          <strong className="text-primary"> Rails monoliths</strong> to 
          <strong className="text-primary"> React tooling</strong> and I've optimized workflows 
          that saved teams 21+ hours weekly.
        </p>
