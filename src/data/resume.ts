...
export const personalInfo = {
  ...
  about: "Full Stack Developer with proven capabilities in distributed systems debugging, API integration, and performance optimization. Proven track record of reverse-engineering undocumented environments to unblock enterprise integrations and contributing production code to core Rails monoliths.",
  location: "Chicago, IL"
};
